...
class SimpleListModel(QAbstractListModel):
    ...
    # We need to tell the view how many rows we have present in our data. see
    # tutorial #3
    ...
    def setData(self, index, value, role=Qt.EditRole):
        ...
        if role == Qt.EditRole:
            ...
            QObject.emit(self, SIGNAL(
                "dataChanged(const QModelIndex&, const QModelIndex &)"), index, index)
            return True
        # unhandled change.
        return False
    ...
    def removeRows(self, row, count, parent=QModelIndex()):
        ...
        # we may have to remove multiple rows, if not, this could be handled
        # simpler.
    ...
    # The easier way, in this case, is to use our own method to do the heavy
    # lifting.
...
class SimpleListView(QListView):
    ...
    def __init__(self, parent=None):
        ...
        # create a menu item for our context menu that will delete the selected
        # item.
...
class MyMainWindow(QWidget):
    ...
    def __init__(self):
        ...
        # let's have a text input and a pushbutton that add an item to our
        # model.
        hbox = QHBoxLayout()
